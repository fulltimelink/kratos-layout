...
func (m *Server) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetPprof()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ServerValidationError{
					field:  "Pprof",
	...
	} else if v, ok := interface{}(m.GetPprof()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return ServerValidationError{
				field:  "Pprof",
				reason: "embedded message failed validation",
...
func (m *Trace) validate(all bool) error {
	...
	// no validation rules for TraceFilePath
...
// Validate checks the field values on Server_PPROF with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *Server_PPROF) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Server_PPROF with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in Server_PPROFMultiError, or
// nil if none found.
func (m *Server_PPROF) ValidateAll() error {
	return m.validate(true)
}

func (m *Server_PPROF) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return Server_PPROFMultiError(errors)
	}

	return nil
}

// Server_PPROFMultiError is an error wrapping multiple validation errors
// returned by Server_PPROF.ValidateAll() if the designated constraints aren't met.
type Server_PPROFMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Server_PPROFMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Server_PPROFMultiError) AllErrors() []error { return m }

// Server_PPROFValidationError is the validation error returned by
// Server_PPROF.Validate if the designated constraints aren't met.
type Server_PPROFValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Server_PPROFValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Server_PPROFValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Server_PPROFValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Server_PPROFValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Server_PPROFValidationError) ErrorName() string { return "Server_PPROFValidationError" }

// Error satisfies the builtin error interface
func (e Server_PPROFValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = Server_PPROFValidationError{}
